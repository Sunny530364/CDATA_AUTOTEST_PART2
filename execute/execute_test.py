...
#清除data目录下的升级文件
os.chdir('C:\\Users\\Administrator\\Desktop\\Cdata_part11\\data')
os.system('del .\*.bin  .\*.tar')
os.chdir(curent_path)

#从个人文件夹中把升级文件复制到data目录下
os.system('copy .\*.bin  C:\\Users\\Administrator\\Desktop\\Cdata_part11\\data')
os.system('copy .\*.tar  C:\\Users\\Administrator\\Desktop\\Cdata_part11\\data')
...
f=open("C:\\Users\\Administrator\\Desktop\\Cdata_part11\\src\\config\\initialization_config.py","w",encoding='utf-8') 
f.writelines(vars)
f.close()

olt_type = table.row_values(7)[3]
...
#进入测试用例的目录
os.chdir('C:\\Users\\Administrator\\Desktop\\Cdata_part11\\tests\\GponSfu')
#执行测试用例
...
pytest_command = 'pytest  ' +command+  ' -s  -x  --alluredir ' \
                 'C:\\Users\\Administrator\\Desktop\\Cdata_part11\\tests\\GponSfu\\workspace\\gpon_sfu_test1\\allure-results'
